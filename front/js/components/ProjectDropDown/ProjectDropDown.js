...
const ProjectDropDown = (props) => {
  ...
  return (
    ...
    />
      <button className="project-drop-button" onClick={() => { props.selectProject(1); openProjectDropDown();}}>
        {props.project1name}
      </button>
      <button className="project-drop-button" onClick={() => { props.selectProject(2); openProjectDropDown();}}>
        {props.project2name}
      </button>
    </div>
    </div>
